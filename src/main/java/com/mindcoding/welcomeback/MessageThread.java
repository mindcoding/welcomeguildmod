...
public class MessageThread extends Thread implements Runnable {
    ...
    @Override public void run() {
    	...
    	if(!bExit)
	    	Minecraft.getMinecraft().thePlayer.sendChatMessage("/g chat " + messageBuilder.toString() 
	    		+ builder.toString());
    		//Minecraft.getMinecraft().thePlayer.sendChatMessage("/msg " + joinName + " " + messageBuilder.toString() 
